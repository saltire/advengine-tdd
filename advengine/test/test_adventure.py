...
class Test_Adventure(unittest.TestCase):
    ...
    def test_gameover_stops_execution_and_runs_after_game(self):
        adv = init_adv({'during_turn': ['message pass',
                                        {'if': 'command test',
                                         'then': ['message pass', 'gameover', 'message other']},
                                        'message other'],
